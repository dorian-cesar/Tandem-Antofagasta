        ...
        if (isset($datos->report->sheets)) {
            foreach ($datos->report->sheets as $tracker) {
                ...
                foreach ($eventos as $evento) {
                    ...
                    if (str_contains($direccion, 'Zona Urbana Antofagasta - 50km/h')) {
                        ...
                        $qry = "INSERT INTO `masgps`.`tandemVelocidad` 
                            (`contrato`, `id_tracker`, `patente`, `fecha`, `start_time`, `duration`, `max_speed`, `lat`, `lng`, `direccion`) 
                            VALUES ('Tandem', '$id_tracker', '$pat', '$ayer', '$start_time', '$duration', '$max_speed', '$lat', '$lng', '$direccion')";
                        ...
                        echo "$ayer : $start_time Sin datos de velocidad mayor a 50km con duración de más de 1 minuto en GeoZonas para la patente : $pat<br>";
                    }
                }
            }
            break;
